...
@section('meta')
    <title>WinMax Bali - About us</title>
            ...
            <div class="profile-modern-main">
                <div class="profile-modern-header">
                    ...
                    <div class="row row-30">
                        <div class="col-lg-6">
                            <p>Berdiri sejak Tahun 2014 kami terus berkomitmen untuk mejadi vendor dan partner yang terbaik bagi client kami
                                Setelah melewati masa ke masa, perubahan terus terjadi didunia teknologi dan sistem informasi.</p>
                            <p>kami WinMaxBali terus berinovasi dan mengiringi kemajuan teknoligi tersebut dengan mengedepankan service kepada client membuat kami bertahan dan berkembang sampai saat ini.</p>
                        </div>
                        <div class="col-lg-6">
