                    ...
                    @if ($blogs->isEmpty())
                        ...
                        <div class="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            <div class="flex items-center gap-3">
                                <a href="{{ route('admin.service.edit', '0') }}" class="inline-flex items-center px-4 py-2 bg-green-600 text-white text-sm rounded hover:bg-green-700">
                                    + New Service
                                </a>
                                ...
                                @foreach ($blogs as $page)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                        ...
                                        <td class="px-4 py-3 align-top text-right space-x-2">
                                            <a href="{{ route('admin.service.edit', $page->id) }}" class="inline-block px-3 py-1 bg-blue-600 text-white text-sm rounded hover:bg-blue-700">Edit</a>

                                            <form action="{{ route('admin.service.delete', $page->id) }}" method="POST" onsubmit="return confirm('Delete this blog?');" class="inline-block">
                                                @csrf
                                                @method('DELETE')
